...
const volume = ref();
onMounted(() => {
    getLyic(playList.value[playIndex.value].id);
...
<template>
    <div class="slide-left">
        <div class="bg" v-if="playList" :style="{ backgroundImage: 'url(' + playList[playIndex].al.picUrl + ')' }"></div>
        <div class="container">
            <div class="main">
                <div class="img">
        ...
        <div class="bottom">
            ...
            <div class="bottom-center">
                ...
                <div class="bottom-center-bottom">
                    ...
                    <div class="Progress"><div class="Progress-childer" :style="{ width: Audio ? (1016 / Audio.duration) * currentTime + 'px' : 0 + 'px' }"></div></div>
                    <div v-if="Audio">{{ convertSeconds(Audio.duration) }}</div>
...
.main {
    ...
    .img1 {
        ...
        height: 65%;
        top: 5%;
        box-shadow: 0 50px 70px rgba(0, 0, 0, 0.1), 0 10px 10px rgba(0, 0, 0, 0.5);
    }
    .img2 {
        position: absolute;
        ...
        width: 31%;
        height: 75%;
        box-shadow: 0 50px 70px rgba(0, 0, 0, 0.5), 0 10px 10px rgba(0, 0, 0, 0.1);
    }
}
.lyrics {
    height: 100%;
...
.bottom {
    ...
    .bottom-left {
        ...
        .left-img1:hover {
            box-shadow: inset rgba(0, 0, 0, 0.9) 0 -3px 8px, inset rgba(252, 255, 255, 0.9) 0 3px 8px, rgba(0, 0, 0, 0.9) 0 3px 8px -3px;
            transform: scale(1.1);
        }
        .left-img2 {
            width: 25px;
...
.top {
    ...
    img:hover {
        transform: scale(1.2);
        background-color: rgba(164, 227, 236, 0.3);
    }
}
